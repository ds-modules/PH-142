...
```{r read-in-data}
library(readr)
natlterr2015_cleaned <- read.csv("natlterr2015_cleaned.csv", stringsAsFactors=FALSE)
```
### Description of the data


These are births by place of ocurrance in the 50 USA states, the District of Columbia, and U.S. territories from the year 2015.  This is a subset of the data downloaded from [here](http://www.nber.org/data/vital-statistics-natality-data.html).
